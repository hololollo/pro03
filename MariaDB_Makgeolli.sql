...
-- 게시판(notice=공지사항)
create table board (no int auto_increment primary key, title varchar(200), content varchar(1000), author varchar(50), vcnt int, resdate timestamp default current_timestamp);
select * from board;
commit;
...
-- 자료실
create table fileboard(fno int auto_increment primary key, title varchar(200), content varchar(1000), url varchar(300), hits int default 0, resdate timestamp default current_timestamp, author varchar(200));
...
create table basket(bno int auto_increment primary key, id varchar(20), pno int, amount int, 
remark varchar(100));
...
-- qna게시판
create table qna(no int auto_increment primary key, title varchar(200), content varchar(1000), lev int default 1, parno int default 0, hits int default 0, resdate timestamp default current_timestamp, id varchar(20), name varchar(100));
