    	...
    	<div id="breadcrumb" class="container breadcrumb-wrap clr-fix" style="height:60px; line-height:60px;">
 	    ...
 	    <section class="page" id="page1">
    		...
    		<div class="page-wrap">
	    		<div class="clr-fix">
	    			<br>
					<form action="${kpath }/sales/inSalesPro.do" method="post">
								...
								<tr>
									...
									<td>
										<div class="item_fr">
											...
											<input type="hidden" name="id" id="id" value="${sid.id }" />
											<input type="hidden" id="email" value="${sid.email }" />
											<input type="hidden" id="custel" value="${sid.tel }" />
											<input type="hidden" id="cusaddr" value="${sid.addr1 }" />
											<input type="hidden" id="cusaddr2" value="${sid.addr2 }" />
											<input type="hidden" id="cuspostcode" value="${sid.postcode }" />
											<input type="hidden" name="gtid" id="gtid" />
											<h4>제품명 : ${product.pname }</h4>
											<img src="${kpath }/resources/upload/${product.img }" alt="${product.pname }" width="120" />
											<br>
											<h4>제품 설명</h4>
											<p>${product.com }</p>
										</div>
