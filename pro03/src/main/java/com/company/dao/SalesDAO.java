...
public interface SalesDAO {
	...
	List<Sales> getAdSalesList();	//관리자 판매 전체 목록
	List<Sales> getAdStSalesList(String st); //관리자 판매 진행 상태별 목록
	List<Sales> getAdDelstSalesList(String delStatus);	//관리자 배송 상태별 목록
