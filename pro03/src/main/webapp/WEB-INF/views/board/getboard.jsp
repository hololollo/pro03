    		...
    		<div class="page-wrap">
 				<div class="clr-fix">
					...
					<div class="buttons">
					  ...
					  <a href="${kpath }/board/insert.do" class="button is-danger">글 등록</a>
					  <a href="${kpath }/board/update.do?bno=${board.bno }" class="button is-warning">글 수정</a>
					  <a href="${kpath }/board/delBoard.do?bno=${board.bno }" class="button is-danger is-dark">글 삭제</a>
					  </c:if>
					  <a href="${kpath }/board/boardList.do" class="button is-primary">글 목록</a>
					</div>
				</div>
    		</div>
    	</section>
